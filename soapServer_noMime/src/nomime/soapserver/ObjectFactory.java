 ...
 * generated in the nomime.soapserver package. 
...
public class ObjectFactory {
    ...
    private final static QName _ServiceMethodRequest_QNAME = new QName("http://soapserver.nomime/", "serviceMethodRequest");
    private final static QName _Attachment_QNAME = new QName("http://soapserver.nomime/", "attachment");
    private final static QName _ServiceMethodResponse_QNAME = new QName("http://soapserver.nomime/", "serviceMethodResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: nomime.soapserver
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserver.nomime/", name = "serviceMethodRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserver.nomime/", name = "attachment")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserver.nomime/", name = "serviceMethodResponse")
