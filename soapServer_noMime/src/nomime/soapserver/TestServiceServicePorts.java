...
public class TestServiceServicePorts extends Service {
    ...
    public final static QName SERVICE = new QName("http://soapserver.nomime/", "TestServiceServicePorts");
    public final static QName TestServicePort = new QName("http://soapserver.nomime/", "TestServicePort");
    static {
        URL url = TestServiceServicePorts.class.getResource("testServiceNoMime.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(TestServiceServicePorts.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "testServiceNoMime.wsdl");
        }       
        WSDL_LOCATION = url;
    }
