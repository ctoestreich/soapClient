...
@javax.jws.WebService(
                      ...
                      wsdlLocation = "testServiceMime.wsdl",
                      endpointInterface = "mime.soapserver.TestService")
...
public class TestServiceImpl implements TestService {
    ...
    /* (non-Javadoc)
     * @see mime.soapserver.TestService#serviceMethod(mime.soapserver.ServiceMethodRequest  inputParameters ,)mime.soapserver.ServiceMethodResponse  outputParameters ,)byte[]  attachment )*
     */
    public void serviceMethod(ServiceMethodRequest inputParameters,javax.xml.ws.Holder<ServiceMethodResponse> outputParameters,javax.xml.ws.Holder<byte[]> attachment) { 
        ...
        try {
            mime.soapserver.ServiceMethodResponse outputParametersValue = new mime.soapserver.ServiceMethodResponse();
            mime.soapserver.ServiceResponse serviceResponse = new mime.soapserver.ServiceResponse();
