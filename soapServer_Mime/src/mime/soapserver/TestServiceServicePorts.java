...
public class TestServiceServicePorts extends Service {
    ...
    static {
        URL url = TestServiceServicePorts.class.getResource("testServiceMime.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(TestServiceServicePorts.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "testServiceMime.wsdl");
        }       
        WSDL_LOCATION = url;
    }
