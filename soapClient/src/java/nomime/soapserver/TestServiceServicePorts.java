 ...
 * 2012-03-13T16:12:33.732-05:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "TestServiceServicePorts", 
                  wsdlLocation = "http://localhost:8082/soapServerNoMime/services/test?wsdl",
...
public class TestServiceServicePorts extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8082/soapServerNoMime/services/test?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TestServiceServicePorts.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8082/soapServerNoMime/services/test?wsdl");
        }
        WSDL_LOCATION = url;
    }
